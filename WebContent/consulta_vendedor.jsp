<!--
ZIRIX CONTROL CENTER - CONSULTA VENDEDOR
...
<%
	String[] pkVal = {request.getParameter("COD_VENDEDOR")};
	VendedorServiceBean bean = new VendedorServiceBean(pkVal);
%>

<div id="administrativo-consulta-vendedor-content">
    <form class="outer_form">
        <ul class="nav nav-tabs">
            <li class="active"><a href="#aba_vendedor" data-toggle="tab">vendedor</a></li>
            <li><a href="#aba_contato" data-toggle="tab">Contatos</a></li>
        </ul>   
        <div class="tab-content"> 
            <div class="tab-pane active" id="aba_vendedor">
            ...
            <div class="div_modal_bt">
	            <button type="button" id="salvar_modal" onclick="administrativo_consultar_vendedor_salvar_function()">Salvar</button>
